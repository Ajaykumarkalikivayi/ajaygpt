/*!
 * Custom AI Assistant Script
 * Created by Ajay and co.
 * Copyright © 2025 Ajay and co. All rights reserved.
 */

(function() {
    const al = document.createElement("link").relList;
    if (al && al.supports && al.supports("modulepreload"))
        return;
    ...
    function G(B) {
        const L = {};
        return B.integrity && (L.integrity = B.integrity),
        B.referrerPolicy && (L.referrerPolicy = B.referrerPolicy),
        B.crossOrigin === "use-credentials" ? L.credentials = "include" : B.crossOrigin === "anonymous" ? L.credentials = "omit" : L.credentials = "same-origin",
        L
    }
    function o(B) {
        if (B.ep)
...
function gh() {
    ...
    function Cl(s, T, p, R, O) {
        ...
        if (Q)
            ...
            Q = R === "" ? "." + Mt(s, 0) : R,
            Jt(O) ? (p = "",
            Q != null && (p = Q.replace(lt, "$&/") + "/"),
            Cl(O, T, p, "", function(bl) {
                return bl
            })) : O != null && (N(O) && (O = Wt(O, p + (O.key == null || s && s.key === O.key ? "" : ("" + O.key).replace(lt, "$&/") + "/") + Q)),
            T.push(O)),
            1;
        Q = 0;
        var xl = R === "" ? "." : R + ":";
    ...
    X.cloneElement = function(s, T, p) {
        ...
        if (T != null)
            ...
            T)
                !Ql.call(T, Q) || Q === "key" || Q === "__self" || Q === "__source" || Q === "ref" && T.ref === void 0 || (R[Q] = T[Q]);
        var Q = arguments.length - 2;
        if (Q === 1)
            R.children = p;
        else if (1 < Q) {
            for (var xl = Array(Q), ul = 0; ul < Q; ul++)
                xl[ul] = arguments[ul + 2];
            R.children = xl
        }
        return wt(s.type, O, void 0, void 0, w, R)
    }
    ,
    ...
    X.createElement = function(s, T, p) {
        var R, O = {}, w = null;
        if (T != null)
            for (R in T.key !== void 0 && (w = "" + T.key),
            T)
                Ql.call(T, R) && R !== "key" && R !== "__self" && R !== "__source" && (O[R] = T[R]);
        var Q = arguments.length - 2;
        if (Q === 1)
            O.children = p;
        else if (1 < Q) {
        ...
        if (s && s.defaultProps)
            for (R in Q = s.defaultProps,
            Q)
                O[R] === void 0 && (O[R] = Q[R]);
        return wt(s, w, void 0, void 0, null, O)
    }
    ,
    ...
    X.startTransition = function(s) {
        ...
        try {
            var R = s()
              , O = P.S;
            O !== null && O(p, R),
            typeof R == "object" && R !== null && typeof R.then == "function" && R.then(il, Y)
        } catch (w) {
            Y(w)
        } finally {
            P.T = T
    ...
    X.useActionState = function(s, T, p) {
        return P.H.useActionState(s, T, p)
    }
    ,
    ...
    X.useImperativeHandle = function(s, T, p) {
        return P.H.useImperativeHandle(s, T, p)
    }
    ,
    ...
    X.useSyncExternalStore = function(s, T, p) {
        return P.H.useSyncExternalStore(s, T, p)
    }
    ,
...
function Sh() {
    ...
    function(A) {
        ...
        function o(z) {
            ...
            if (Y !== x) {
                z[0] = Y;
                l: for (var il = 0, s = z.length, T = s >>> 1; il < T; ) {
                    var p = 2 * (il + 1) - 1
                      , R = z[p]
                      , O = p + 1
                      , w = z[O];
        ...
        function B(z, x) {
            var Y = z.sortIndex - x.sortIndex;
            return Y !== 0 ? Y : z.id - x.id
        }
                ...
                try {
                    l: {
                        ...
                        try {
                            t: {
                                for (ht(z),
                                Z = G(D); Z !== null && !(Z.expirationTime > z && N()); ) {
                                    var il = Z.callback;
                                    if (typeof il == "function") {
                                        Z.callback = null,
                                        $ = Z.priorityLevel;
                                        var s = il(Z.expirationTime <= z);
                                        if (z = A.unstable_now(),
                                        typeof s == "function") {
                                            Z.callback = s,
                                            ht(z),
        ...
        ,
        A.unstable_scheduleCallback = function(z, x, Y) {
            ...
            Y > il ? (z.sortIndex = Y,
            al(S, z),
            G(D) === null && z === G(S) && (Il ? (Dt(Ql),
            Ql = -1) : Il = !0,
            Cl(Jt, Y - il))) : (z.sortIndex = s,
            al(D, z),
            zl || fl || (zl = !0,
            Ut())),
            z
...
function Eh() {
    ...
    ,
    Bl.preinit = function(D, S) {
        if (typeof D == "string" && S && typeof S.as == "string") {
            var q = S.as
              , Z = ol(q, S.crossOrigin)
              , $ = typeof S.integrity == "string" ? S.integrity : void 0
              , fl = typeof S.fetchPriority == "string" ? S.fetchPriority : void 0;
            q === "style" ? o.d.S(D, typeof S.precedence == "string" ? S.precedence : void 0, {
                crossOrigin: Z,
                integrity: $,
                fetchPriority: fl
            }) : q === "script" && o.d.X(D, {
    ...
    ,
    Bl.preinitModule = function(D, S) {
        if (typeof D == "string")
            if (typeof S == "object" && S !== null) {
                if (S.as == null || S.as === "script") {
                    var q = ol(S.as, S.crossOrigin);
                    o.d.M(D, {
                        crossOrigin: q,
    ...
    ,
    Bl.unstable_batchedUpdates = function(D, S) {
        return D(S)
    }
    ,
    Bl.useFormState = function(D, S, q) {
        return tl.H.useFormState(D, S, q)
    }
    ,
...
function Ah() {
    ...
    var N = al.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, I = Object.assign, lt, Mt;
    function St(l) {
        if (lt === void 0)
            try {
                throw Error()
...
` + i[a].replace(" at new ", " at ");
    ...
    function z(l) {
        ...
        case 0:
        case 15:
            return l = Cl(l.type, !1),
            l;
        case 11:
            return l = Cl(l.type.render, !1),
            l;
        case 1:
            return l = Cl(l.type, !0),
            l;
        default:
            return ""
        }
...
` + u.stack
    ...
    function kt(l) {
        if (typeof Fd == "function" && Pd(l),
        Jl && typeof Jl.setStrictMode == "function")
            try {
                Jl.setStrictMode(_a, l)
            } catch {}
    }
    var wl = Math.clz32 ? Math.clz32 : uv
      , lv = Math.log
      , tv = Math.LN2;
    function uv(l) {
        return l >>>= 0,
        l === 0 ? 32 : 31 - (lv(l) / tv | 0) | 0
    }
    var Me = 128
      , Ue = 4194304;
    function bu(l) {
    ...
    var Rt = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u")
      , iv = RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$")
      , hi = {}
      , oi = {};
    function sv(l) {
        return Xn.call(oi, l) ? !0 : Xn.call(hi, l) ? !1 : iv.test(l) ? oi[l] = !0 : (hi[l] = !0,
        !1)
    }
    function He(l, t, u) {
        if (sv(t))
    ...
    function mi(l) {
        ...
        var u = t.getValue()
          , a = "";
        return l && (a = ri(l) ? l.checked ? "true" : "false" : l.value),
        l = a,
        l !== u ? (t.setValue(l),
        !0) : !1
    }
    ...
    var yv = new Set("animationIterationCount aspectRatio borderImageOutset borderImageSlice borderImageWidth boxFlex boxFlexGroup boxOrdinalGroup columnCount columns flex flexGrow flexPositive flexShrink flexNegative flexOrder gridArea gridRow gridRowEnd gridRowSpan gridRowStart gridColumn gridColumnEnd gridColumnSpan gridColumnStart fontWeight lineClamp lineHeight opacity order orphans scale tabSize widows zIndex zoom fillOpacity floodOpacity stopOpacity strokeDasharray strokeDashoffset strokeMiterlimit strokeOpacity strokeWidth MozAnimationIterationCount MozBoxFlex MozBoxFlexGroup MozLineClamp msAnimationIterationCount msFlex msZoom msFlexGrow msFlexNegative msFlexOrder msFlexPositive msFlexShrink msGridColumn msGridColumnSpan msGridRow msGridRowSpan WebkitAnimationIterationCount WebkitBoxFlex WebKitBoxFlexGroup WebkitBoxOrdinalGroup WebkitColumnCount WebkitColumns WebkitFlex WebkitFlexGrow WebkitFlexPositive WebkitFlexShrink WebkitLineClamp".split(" "));
    function Ei(l, t, u) {
        var a = t.indexOf("--") === 0;
        u == null || typeof u == "boolean" || u === "" ? a ? l.setProperty(t, "") : t === "float" ? l.cssFloat = "" : l[t] = "" : a ? l.setProperty(t, u) : typeof u != "number" || u === 0 || yv.has(t) ? t === "float" ? l.cssFloat = u : l[t] = ("" + u).trim() : l[t] = u + "px"
    }
    function Ti(l, t, u) {
    ...
    var hv = new Map([["acceptCharset", "accept-charset"], ["htmlFor", "for"], ["httpEquiv", "http-equiv"], ["crossOrigin", "crossorigin"], ["accentHeight", "accent-height"], ["alignmentBaseline", "alignment-baseline"], ["arabicForm", "arabic-form"], ["baselineShift", "baseline-shift"], ["capHeight", "cap-height"], ["clipPath", "clip-path"], ["clipRule", "clip-rule"], ["colorInterpolation", "color-interpolation"], ["colorInterpolationFilters", "color-interpolation-filters"], ["colorProfile", "color-profile"], ["colorRendering", "color-rendering"], ["dominantBaseline", "dominant-baseline"], ["enableBackground", "enable-background"], ["fillOpacity", "fill-opacity"], ["fillRule", "fill-rule"], ["floodColor", "flood-color"], ["floodOpacity", "flood-opacity"], ["fontFamily", "font-family"], ["fontSize", "font-size"], ["fontSizeAdjust", "font-size-adjust"], ["fontStretch", "font-stretch"], ["fontStyle", "font-style"], ["fontVariant", "font-variant"], ["fontWeight", "font-weight"], ["glyphName", "glyph-name"], ["glyphOrientationHorizontal", "glyph-orientation-horizontal"], ["glyphOrientationVertical", "glyph-orientation-vertical"], ["horizAdvX", "horiz-adv-x"], ["horizOriginX", "horiz-origin-x"], ["imageRendering", "image-rendering"], ["letterSpacing", "letter-spacing"], ["lightingColor", "lighting-color"], ["markerEnd", "marker-end"], ["markerMid", "marker-mid"], ["markerStart", "marker-start"], ["overlinePosition", "overline-position"], ["overlineThickness", "overline-thickness"], ["paintOrder", "paint-order"], ["panose-1", "panose-1"], ["pointerEvents", "pointer-events"], ["renderingIntent", "rendering-intent"], ["shapeRendering", "shape-rendering"], ["stopColor", "stop-color"], ["stopOpacity", "stop-opacity"], ["strikethroughPosition", "strikethrough-position"], ["strikethroughThickness", "strikethrough-thickness"], ["strokeDasharray", "stroke-dasharray"], ["strokeDashoffset", "stroke-dashoffset"], ["strokeLinecap", "stroke-linecap"], ["strokeLinejoin", "stroke-linejoin"], ["strokeMiterlimit", "stroke-miterlimit"], ["strokeOpacity", "stroke-opacity"], ["strokeWidth", "stroke-width"], ["textAnchor", "text-anchor"], ["textDecoration", "text-decoration"], ["textRendering", "text-rendering"], ["transformOrigin", "transform-origin"], ["underlinePosition", "underline-position"], ["underlineThickness", "underline-thickness"], ["unicodeBidi", "unicode-bidi"], ["unicodeRange", "unicode-range"], ["unitsPerEm", "units-per-em"], ["vAlphabetic", "v-alphabetic"], ["vHanging", "v-hanging"], ["vIdeographic", "v-ideographic"], ["vMathematical", "v-mathematical"], ["vectorEffect", "vector-effect"], ["vertAdvY", "vert-adv-y"], ["vertOriginX", "vert-origin-x"], ["vertOriginY", "vert-origin-y"], ["wordSpacing", "word-spacing"], ["writingMode", "writing-mode"], ["xmlnsXlink", "xmlns:xlink"], ["xHeight", "x-height"]])
      , ov = /^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*:/i;
    function Ye(l) {
        return ov.test("" + l) ? "javascript:throw new Error('React has blocked a javascript: URL as a security precaution.')" : l
    }
    var Wn = null;
    function $n(l) {
    ...
    function Oi() {
        if (Be)
            return Be;
        var l, t = Pn, u = t.length, a, e = "value"in Pt ? Pt.value : Pt.textContent, n = e.length;
    ...
    function Vl(l) {
        function t(u, a, e, n, f) {
            ...
            for (var c in l)
                ...
                this[c] = u ? u(n) : n[c]);
            return this.isDefaultPrevented = (n.defaultPrevented != null ? n.defaultPrevented : n.returnValue === !1) ? xe : _i,
    ...
    var Au = {
        ...
        movementX: function(l) {
            return "movementX"in l ? l.movementX : (l !== qa && (qa && l.type === "mousemove" ? (In = l.screenX - qa.screenX,
            lf = l.screenY - qa.screenY) : lf = In = 0,
            qa = l),
            In)
        },
    ...
    var Uv = I({}, pa, {
        key: function(l) {
            ...
            return l.type === "keypress" ? (l = je(l),
            l === 13 ? "Enter" : String.fromCharCode(l)) : l.type === "keydown" || l.type === "keyup" ? _v[l.keyCode] || "Unidentified" : ""
        },
        code: 0,
        location: 0,
        ctrlKey: 0,
    ...
    var Qv = Rt && "TextEvent"in window && !Ya
      , Ri = Rt && (!af || Ya && 8 < Ya && 11 >= Ya)
      , Hi = " "
      , Ni = !1;
    function pi(l, t) {
        switch (l) {
    ...
    function Zv(l, t) {
        if (ku)
            return l === "compositionend" || !af && pi(l, t) ? (l = Oi(),
            Be = Pn = Pt = null,
            ku = !1,
            l) : null;
        switch (l) {
    ...
    function Xi() {
        Ba && (Ba.detachEvent("onpropertychange", Qi),
        ja = Ba = null)
    }
    function Qi(l) {
    ...
    function Kv(l, t, u) {
        ...
        Ba = t,
        ja = u,
        Ba.attachEvent("onpropertychange", Qi)) : l === "focusout" && Xi()
    }
    function Jv(l) {
    ...
    function kv(l, t) {
        ...
        if (u !== t && t && t.ownerDocument && Vi(t.ownerDocument.documentElement, t)) {
            if (a !== null && ff(t)) {
                if (l = a.start,
                u = a.end,
                u === void 0 && (u = l),
    ...
    var Pu = {
      ...
      , df = {}
      , Ji = {};
    Rt && (Ji = document.createElement("div").style,
    ...
    function us(l) {
        ...
        case "input":
            J("invalid", t),
            gi(t, a.value, a.defaultValue, a.checked, a.defaultChecked, a.type, a.name, !0),
            pe(t);
            break;
        case "select":
            J("invalid", t);
        ...
        case "textarea":
            J("invalid", t),
            bi(t, a.value, a.defaultValue, a.children),
            pe(t)
        }
        u = a.children,
        typeof u != "string" && typeof u != "number" && typeof u != "bigint" || t.textContent === "" + u || a.suppressHydrationWarning === !0 || vd(t.textContent, u) ? (a.popover != null && (J("beforetoggle", t),
        J("toggle", t)),
    ...
    function Xa(l) {
        ...
        l.tag === 13) {
            ...
            Hl = Gl ? gt(l.stateNode.nextSibling) : null;
        return !0
    }
    function Qa() {
        Hl = Gl = null,
    ...
    function fs(l, t, u) {
        switch (u = l[u],
        u === void 0 ? l.push(t) : u !== t && (t.then(Je, Je),
        t = u),
        t.status) {
        case "fulfilled":
            return t.value;
    ...
    function We(l, t) {
        throw t.$$typeof === L ? Error(o(525)) : (l = Object.prototype.toString.call(t),
    ...
    function ss(l) {
        ...
        function a(y) {
            for (var d = new Map; y !== null; )
                y.key !== null ? d.set(y.key, y) : d.set(y.index, y),
                y = y.sibling;
            return d
        }
        function e(y, d) {
        ...
        function n(y, d, h) {
            ...
            l ? (h = y.alternate,
            h !== null ? (h = h.index,
            h < d ? (y.flags |= 33554434,
            d) : h) : (y.flags |= 33554434,
            d)) : (y.flags |= 1048576,
            d)
        }
        function f(y) {
            return l && y.alternate === null && (y.flags |= 33554434),
            y
        }
        function c(y, d, h, b) {
            return d === null || d.tag !== 6 ? (d = dc(h, y.mode, b),
            d.return = y,
            d) : (d = e(d, h),
            d.return = y,
            d)
        ...
        function i(y, d, h, b) {
            var _ = h.type;
            return _ === D ? g(y, d, h.props.children, b, h.key) : d !== null && (d.elementType === _ || typeof _ == "object" && _ !== null && _.$$typeof === jl && is(_) === d.type) ? (d = e(d, h.props),
            Ka(d, h),
            d.return = y,
            d) : (d = hn(h.type, h.key, h.props, null, y.mode, b),
            Ka(d, h),
            d.return = y,
            d)
        }
        function v(y, d, h, b) {
            return d === null || d.tag !== 4 || d.stateNode.containerInfo !== h.containerInfo || d.stateNode.implementation !== h.implementation ? (d = vc(h, y.mode, b),
            d.return = y,
            d) : (d = e(d, h.children || []),
            d.return = y,
            d)
        }
        function g(y, d, h, b, _) {
            return d === null || d.tag !== 7 ? (d = xu(h, y.mode, b, _),
            d.return = y,
            d) : (d = e(d, h),
            d.return = y,
            d)
        ...
        function E(y, d, h) {
            if (typeof d == "string" && d !== "" || typeof d == "number" || typeof d == "bigint")
                return d = dc("" + d, y.mode, h),
                d.return = y,
                d;
            if (typeof d == "object" && d !== null) {
                switch (d.$$typeof) {
                case tl:
                    return h = hn(d.type, d.key, d.props, null, y.mode, h),
                    Ka(h, d),
                    h.return = y,
                    h;
                case ol:
                    return d = vc(d, y.mode, h),
                    d.return = y,
                    d;
                case jl:
                    var b = d._init;
        ...
        function r(y, d, h, b) {
            ...
            if (typeof h == "string" && h !== "" || typeof h == "number" || typeof h == "bigint")
                return _ !== null ? null : c(y, d, "" + h, b);
            if (typeof h == "object" && h !== null) {
                switch (h.$$typeof) {
                case tl:
                    return h.key === _ ? i(y, d, h, b) : null;
                case ol:
                    return h.key === _ ? v(y, d, h, b) : null;
                case jl:
                    return _ = h._init,
                    h = _(h._payload),
                    r(y, d, h, b)
                ...
                if (R(h) || Ql(h))
                    return _ !== null ? null : g(y, d, h, b, null);
                if (typeof h.then == "function")
                    return r(y, d, we(h), b);
                if (h.$$typeof === fl)
                    return r(y, d, dn(y, h), b);
                We(y, h)
            }
            return null
        }
        function m(y, d, h, b, _) {
            if (typeof b == "string" && b !== "" || typeof b == "number" || typeof b == "bigint")
                return y = y.get(h) || null,
                c(d, y, "" + b, _);
            if (typeof b == "object" && b !== null) {
                switch (b.$$typeof) {
                case tl:
                    return y = y.get(b.key === null ? h : b.key) || null,
                    i(d, y, b, _);
                case ol:
                    return y = y.get(b.key === null ? h : b.key) || null,
                    v(d, y, b, _);
                ...
                if (typeof b.then == "function")
                    return m(y, d, h, we(b), _);
                if (b.$$typeof === fl)
                    return m(y, d, h, dn(d, b), _);
                We(d, b)
            }
            return null
        }
        function M(y, d, h, b) {
            for (var _ = null, V = null, U = d, H = d = 0, Rl = null; U !== null && H < h.length; H++) {
                U.index > H ? (Rl = U,
                U = null) : Rl = U.sibling;
                var F = r(y, U, h[H], b);
                if (F === null) {
            ...
            for (U = a(U); H < h.length; H++)
                Rl = m(U, y, H, h[H], b),
                Rl !== null && (l && Rl.alternate !== null && U.delete(Rl.key === null ? H : Rl.key),
                d = n(Rl, d, H),
        ...
        function j(y, d, h, b) {
            if (h == null)
                throw Error(o(151));
            for (var _ = null, V = null, U = d, H = d = 0, Rl = null, F = h.next(); U !== null && !F.done; H++,
            F = h.next()) {
                U.index > H ? (Rl = U,
                U = null) : Rl = U.sibling;
                var Su = r(y, U, F.value, b);
                if (Su === null) {
                    U === null && (U = Rl);
                    break
                }
            ...
            F = h.next())
                F = m(U, y, H, F.value, b),
                F !== null && (l && F.alternate !== null && U.delete(F.key === null ? H : F.key),
                d = n(F, d, H),
                V === null ? _ = F : V.sibling = F,
                V = F);
            return l && U.forEach(function(oh) {
                return t(y, oh)
            }),
            k && Du(y, H),
            _
        ...
        function gl(y, d, h, b) {
            if (typeof h == "object" && h !== null && h.type === D && h.key === null && (h = h.props.children),
            typeof h == "object" && h !== null) {
                switch (h.$$typeof) {
                case tl:
                    l: {
                        for (var _ = h.key; d !== null; ) {
                            if (d.key === _) {
                                if (_ = h.type,
                                _ === D) {
                                    if (d.tag === 7) {
                                ...
                                } else if (d.elementType === _ || typeof _ == "object" && _ !== null && _.$$typeof === jl && is(_) === d.type) {
                                    u(y, d.sibling),
                                    b = e(d, h.props),
                                    Ka(b, h),
                                    b.return = y,
                        ...
                        h.type === D ? (b = xu(h.props.children, y.mode, b, h.key),
                        b.return = y,
                        y = b) : (b = hn(h.type, h.key, h.props, null, y.mode, b),
                        Ka(b, h),
                        b.return = y,
                        y = b)
                    }
                ...
                if (typeof h.then == "function")
                    return gl(y, d, we(h), b);
                if (h.$$typeof === fl)
                    return gl(y, d, dn(y, h), b);
                We(y, h)
            }
            return typeof h == "string" && h !== "" || typeof h == "number" || typeof h == "bigint" ? (h = "" + h,
            d !== null && d.tag === 6 ? (u(y, d.sibling),
            b = e(d, h),
            b.return = y,
            y = b) : (u(y, d),
            b = dc(h, y.mode, b),
    ...
    function lu(l) {
        ...
        vl(Ol, Ol.current & 1),
        vl(ct, l),
        At === null && (t === null || ea.current !== null || t.memoizedState !== null) && (At = l)
    }
    function ys(l) {
        if (l.tag === 22) {
            if (vl(Ol, Ol.current),
    ...
    var os = N.S;
    N.S = function(l, t) {
        typeof t == "object" && t !== null && typeof t.then == "function" && ey(l, t),
        os !== null && os(l, t)
    }
    ;
    var Ru = ul(null);
    ...
    function Fe(l, t) {
        t === null ? vl(Ru, Ru.current) : vl(Ru, t.pool)
    }
    function rs() {
        var l = Tf();
        return l === null ? null : {
    ...
    function cy() {
        ...
        l = l.useState()[0],
        (el !== null ? el.memoizedState : null) !== l && (C.flags |= 1024),
        t
    }
    function Of() {
        var l = Ie !== 0;
    ...
    function Ll() {
        ...
        return El === null ? C.memoizedState = El = l : El = El.next = l,
        El
    }
    function Tl() {
        if (el === null) {
    ...
    function Os(l, t, u, a) {
        ...
        Uf(l, el, typeof a == "function" ? a : Yt)
    }
    ...
    function ps(l, t, u) {
        ...
        var a = Tl()
          , e = a.queue
          , n = e.dispatch;
        return u !== a.memoizedState && (C.flags |= 2048,
        sa(9, sy.bind(null, e, u), {
            destroy: void 0
        }, null)),
        [t, n, l]
    }
    ...
    function en(l, t, u, a) {
        ...
        el !== null && a !== null && Af(a, el.memoizedState.deps) ? e.memoizedState = sa(t, u, n, a) : (C.flags |= l,
        e.memoizedState = sa(1 | t, u, n, a))
    }
    function Bs(l, t) {
        an(8390656, 8, l, t)
    }
    ...
    function Qs(l, t) {
        ...
        return t !== null && Af(t, a[1]) ? a[0] : (u.memoizedState = [l, t],
        l)
    }
    function Cs(l, t) {
        var u = Tl();
    ...
    function Yf(l, t, u) {
        return u === void 0 || (uu & 1073741824) !== 0 ? l.memoizedState = t : (l.memoizedState = u,
        l = V0(),
        C.lanes |= l,
        yu |= l,
        u)
    ...
    function Zs(l, t, u, a) {
        return Wl(u, t) ? u : ea.current !== null ? (l = Yf(l, u, a),
        Wl(l, t) || (Ml = !0),
        l) : (uu & 42) === 0 ? (Ml = !0,
        l.memoizedState = u) : (l = V0(),
        C.lanes |= l,
        yu |= l,
        t)
    }
    ...
    zt.useCacheRefresh = Sl,
    zt.useMemoCache = Sl,
    zt.useHostTransitionStatus = Sl,
    zt.useFormState = Sl,
    zt.useActionState = Sl,
    zt.useOptimistic = Sl;
    var Nu = {
        readContext: Yl,
        use: tn,
        useCallback: function(l, t) {
            return Ll().memoizedState = [l, t === void 0 ? null : t],
            l
        },
        useContext: Yl,
        useEffect: Bs,
        ...
        useTransition: function() {
            var l = Hf(!1);
            return l = Vs.bind(null, C, l.queue, !0, !1),
            Ll().memoizedState = l,
            [!1, l]
        },
        useSyncExternalStore: function(l, t, u) {
            ...
            return e.queue = n,
            Bs(Ts.bind(null, a, n, l), [l]),
            a.flags |= 2048,
            sa(9, Es.bind(null, a, n, u, t), {
                destroy: void 0
            }, null),
            u
        },
        ...
        useCacheRefresh: function() {
            return Ll().memoizedState = vy.bind(null, C)
        }
    };
    Nu.useMemoCache = Mf,
    Nu.useHostTransitionStatus = jf,
    Nu.useFormState = Hs,
    ...
    var au = {
        ...
        useDeferredValue: function(l, t) {
            var u = Tl();
            return Zs(u, el.memoizedState, l, t)
        },
        useTransition: function() {
            var l = un(Yt)[0]
              , t = Tl().memoizedState;
    ...
    var pu = {
        ...
        useDeferredValue: function(l, t) {
            var u = Tl();
            return el === null ? Yf(u, l, t) : Zs(u, el.memoizedState, l, t)
        },
        useTransition: function() {
            var l = Rf(Yt)[0]
              , t = Tl().memoizedState;
    ...
    pu.useOptimistic = function(l, t) {
        var u = Tl();
        return el !== null ? Os(u, el, l, t) : (u.baseState = l,
        [l, u.queue.dispatch])
    }
    ;
    function Gf(l, t, u, a) {
    ...
    function Fs(l, t, u, a, e, n, f) {
        ...
        typeof l.shouldComponentUpdate == "function" ? l.shouldComponentUpdate(a, n, f) : t.prototype && t.prototype.isPureReactComponent ? !xa(u, a) || !xa(e, n) : !0
    }
    function Ps(l, t, u, a) {
        l = t.state,
    ...
    function e0(l, t, u, a) {
        ...
        f !== null && typeof f.componentDidCatch == "function" && (l.callback = function() {
            u0(t, u, a),
            typeof e != "function" && (hu === null ? hu = new Set([this]) : hu.add(this));
            var c = a.stack;
    ...
    function hy(l, t, u, a, e) {
        ...
        a !== null && typeof a == "object" && typeof a.then == "function") {
            ...
            u !== null) {
                switch (u.tag) {
                case 13:
                    return At === null ? Tc() : u.alternate === null && ml === 0 && (ml = 3),
                    u.flags &= -257,
                    u.flags |= 65536,
                    u.lanes = e,
        ...
        do {
            ...
            case 1:
                if (t = u.type,
                n = u.stateNode,
                (u.flags & 128) === 0 && (typeof t.getDerivedStateFromError == "function" || n !== null && typeof n.componentDidCatch == "function" && (hu === null || !hu.has(n))))
                    return u.flags |= 65536,
                    e &= -e,
                    u.lanes |= e,
                    e = a0(e),
    ...
    function c0(l, t, u, a, e) {
        if (l === null) {
            var n = u.type;
            return typeof n == "function" && !sc(n) && n.defaultProps === void 0 && u.compare === null ? (t.tag = 15,
            t.type = n,
            i0(l, t, n, a, e)) : (l = hn(u.type, null, a, t, t.mode, e),
            l.ref = t.ref,
            l.return = t,
            t.child = l)
        }
    ...
    function s0(l, t, u) {
        ...
        a.mode === "hidden" || n) {
            ...
            f !== null ? (Fe(t, f.cachePool),
            vs(t, f),
            tu(),
            t.memoizedState = null) : (l !== null && Fe(t, null),
            gf(),
            tu());
        return Nl(l, t, e, u),
        t.child
    ...
    function y0(l, t, u, a, e) {
        ...
        t.stateNode === null) {
            ...
            var v = n.context
              , g = u.contextType;
            f = la,
            typeof g == "object" && g !== null && (f = Yl(g));
            var E = u.getDerivedStateFromProps;
            g = typeof E == "function" || typeof n.getSnapshotBeforeUpdate == "function",
            c = t.pendingProps !== c,
            g || typeof n.UNSAFE_componentWillReceiveProps != "function" && typeof n.componentWillReceiveProps != "function" || (c || v !== f) && Ps(t, n, a, f),
            nu = !1;
            ...
            le(),
            v = t.memoizedState,
            c || r !== v || nu ? (typeof E == "function" && (Gf(t, u, E, a),
            v = t.memoizedState),
            (i = nu || Fs(t, u, i, a, r, v, f)) ? (g || typeof n.UNSAFE_componentWillMount != "function" && typeof n.componentWillMount != "function" || (typeof n.componentWillMount == "function" && n.componentWillMount(),
            typeof n.UNSAFE_componentWillMount == "function" && n.UNSAFE_componentWillMount()),
            ...
            (v = typeof c == "function" || typeof n.getSnapshotBeforeUpdate == "function") || typeof n.UNSAFE_componentWillReceiveProps != "function" && typeof n.componentWillReceiveProps != "function" || (f !== E || r !== i) && Ps(t, n, a, i),
            nu = !1,
            r = t.memoizedState,
            n.state = r,
            te(t, a, n, e),
            ...
            f !== E || r !== m || nu || l !== null && l.dependencies !== null && sn(l.dependencies) ? (typeof c == "function" && (Gf(t, u, c, a),
            m = t.memoizedState),
            (g = nu || Fs(t, u, g, a, r, m, i) || l !== null && l.dependencies !== null && sn(l.dependencies)) ? (v || typeof n.UNSAFE_componentWillUpdate != "function" && typeof n.componentWillUpdate != "function" || (typeof n.componentWillUpdate == "function" && n.componentWillUpdate(a, m, i),
            typeof n.UNSAFE_componentWillUpdate == "function" && n.UNSAFE_componentWillUpdate(a, m, i)),
            typeof n.componentDidUpdate == "function" && (t.flags |= 4),
            typeof n.getSnapshotBeforeUpdate == "function" && (t.flags |= 1024)) : (typeof n.componentDidUpdate != "function" || f === l.memoizedProps && r === l.memoizedState || (t.flags |= 4),
            typeof n.getSnapshotBeforeUpdate != "function" || f === l.memoizedProps && r === l.memoizedState || (t.flags |= 1024),
            t.memoizedProps = a,
            t.memoizedState = m),
            n.props = a,
            n.state = m,
            n.context = i,
            a = g) : (typeof n.componentDidUpdate != "function" || f === l.memoizedProps && r === l.memoizedState || (t.flags |= 4),
            typeof n.getSnapshotBeforeUpdate != "function" || f === l.memoizedProps && r === l.memoizedState || (t.flags |= 1024),
            a = !1)
        }
        return n = a,
        ...
        t.flags |= 1,
        l !== null && a ? (t.child = Uu(t, l.child, null, e),
        t.child = Uu(t, null, u, e)) : Nl(l, t, u, e),
    ...
    function o0(l, t, u) {
        ...
        if ((f = n) || (f = l !== null && l.memoizedState === null ? !1 : (Ol.current & 2) !== 0),
        f && (e = !0,
        t.flags &= -129),
        f = (t.flags & 32) !== 0,
        t.flags &= -33,
        ...
        c !== null)) {
            if (n)
                t.flags & 256 ? (lu(t),
                t.flags &= -257,
                t = wf(l, t, u)) : t.memoizedState !== null ? (tu(),
                t.child = l.child,
                t.flags |= 128,
                t = null) : (tu(),
                e = a.fallback,
        ...
        v !== null ? e = vu(v, e) : (e = xu(e, c, u, null),
        e.flags |= 2),
        e.return = t,
        a.return = t,
        a.sibling = e,
        ...
        c === null ? c = Vf(u) : (i = c.cachePool,
        i !== null ? (v = _l._currentValue,
        i = i.parent !== v ? {
            parent: v,
            pool: v
        } : i) : i = rs(),
    ...
    function oy(l, t, u) {
        ...
        case 13:
            ...
            if (a !== null)
                return a.dehydrated !== null ? (lu(t),
                t.flags |= 128,
                null) : (u & t.child.childLanes) !== 0 ? o0(l, t, u) : (lu(t),
                l = Bt(l, t, u),
    ...
    function g0(l, t, u) {
        if (l !== null)
            ...
            Ml = !1,
            k && (t.flags & 1048576) !== 0 && ts(t, Ke, t.index);
        switch (t.lanes = 0,
        t.tag) {
        case 16:
            l: {
            ...
            l: {
                ...
                e.isDehydrated)
                    ...
                    t.flags & 256) {
                        ...
                        for (Hl = gt(t.stateNode.containerInfo.firstChild),
                        Gl = t,
                        k = !0,
                        rt = null,
                        Tt = !0,
        ...
        case 26:
            return Fa(l, t),
            l === null ? (u = Ed(t.type, null, t.pendingProps, null)) ? t.memoizedState = u : k || (u = t.type,
            l = t.pendingProps,
        ...
        case 27:
            return Gn(t),
            l === null && k && (a = t.stateNode = gd(t.type, t.pendingProps, $t.current),
            Gl = t,
            Tt = !0,
            Hl = gt(a.firstChild)),
            a = t.pendingProps.children,
            l !== null || k ? Nl(l, t, a, u) : t.child = Uu(t, null, a, u),
            Fa(l, t),
            t.child;
        case 5:
            return l === null && k && ((e = a = Hl) && (a = Ly(a, t.type, t.pendingProps, Tt),
            ...
            t.memoizedState !== null && (e = zf(l, t, cy, null, null, u),
            me._currentValue = e),
            Fa(l, t),
            Nl(l, t, a, u),
            t.child;
        case 6:
            return l === null && k && ((l = u = Hl) && (u = Ky(u, t.pendingProps, Tt),
        ...
        case 7:
            return Nl(l, t, t.pendingProps, u),
            t.child;
        case 8:
            return Nl(l, t, t.pendingProps.children, u),
            t.child;
        case 12:
            return Nl(l, t, t.pendingProps.children, u),
            t.child;
    ...
    var kf = ul(null)
      ...
      , jt = null;
    function eu(l, t, u) {
        vl(kf, t._currentValue),
        t._currentValue = u
    }
    function xt(l) {
        l._currentValue = kf.current,
        bl(kf)
    }
    function Ff(l, t, u) {
        for (; l !== null; ) {
    ...
    function te(l, t, u, a) {
        ...
        if (c !== null) {
            ...
            c = g.lastBaseUpdate,
            c !== f && (c === null ? g.firstBaseUpdate = v : c.next = v,
            g.lastBaseUpdate = i))
        }
        if (n !== null) {
            var E = e.baseState;
            ...
            do {
                ...
                if (m ? (W & r) === r : (a & r) === r) {
                    ...
                    l: {
                        ...
                        case 0:
                            if (M = j.payload,
                            r = typeof M == "function" ? M.call(gl, E, r) : M,
                            r == null)
                                break l;
                            E = I({}, E, r);
                            break l;
    ...
    function A0(l, t, u) {
        u.props = qu(l.type, l.memoizedProps),
                ...
                l: {
                    ...
                    if (a && a.rangeCount !== 0) {
                        ...
                        var f = 0
                          ...
                          , r = null;
                        t: for (; ; ) {
                            for (var m; E !== u || e !== 0 && E.nodeType !== 3 || (c = f + e),
    ...
    function U0(l, t, u) {
        ...
        case 13:
            ...
            break;
        case 22:
            if (e = u.memoizedState !== null || Gt,
            !e) {
                t = t !== null && t.memoizedState !== null || rl;
                var n = Gt
                  , f = rl;
                Gt = e,
                (rl = t) && !f ? su(l, u, (u.subtreeFlags & 8772) !== 0) : Qt(l, u),
                Gt = n,
                rl = f
            }
    ...
    function H0(l, t, u) {
        ...
        case 18:
            Al !== null && (kl ? (t = Al,
            u = u.stateNode,
            t.nodeType === 8 ? xc(t.parentNode, u) : t.nodeType === 1 && xc(t, u),
            Ee(t)) : xc(Al, u.stateNode));
            break;
        case 4:
            a = Al,
            e = kl,
    ...
    function my(l) {
        ...
        case 19:
            var t = l.stateNode;
            return t === null && (t = l.stateNode = new D0),
            t;
        case 22:
            return l = l.stateNode,
            t = l._retryCache,
    ...
    function p0(l, t) {
            ...
            a & 4) {
                ...
                u === null)
                    if (a === null)
                        if (l.stateNode === null) {
                            l: {
                                ...
                                case "title":
                                    ...
                                    (!n || n[Ua] || n[ql] || n.namespaceURI === "http://www.w3.org/2000/svg" || n.hasAttribute("itemprop")) && (n = e.createElement(a),
                                ...
                                case "link":
                                    ...
                                    break;
                                case "meta":
                                    if (f = zd("meta", "content", e).get(a + (u.content || ""))) {
                        ...
                        l.stateNode = Ad(e, a, l.memoizedProps);
                else
                    n !== a ? (n === null ? u.stateNode !== null && (u = u.stateNode,
                    u.parentNode.removeChild(u)) : n.count--,
                    a === null ? Od(e, l.type, l.stateNode) : Ad(e, a, l.memoizedProps)) : a === null && l.stateNode !== null && O0(l, l.memoizedProps, u.memoizedProps)
            }
            break;
        case 27:
            if (a & 4 && l.alternate === null) {
                ...
                try {
                    for (var i = e.firstChild; i; ) {
                        var v = i.nextSibling
                          , g = i.nodeName;
                        i[Ua] || g === "HEAD" || g === "BODY" || g === "SCRIPT" || g === "STYLE" || g === "LINK" && i.rel.toLowerCase() === "stylesheet" || e.removeChild(i),
                        i = v
                    }
                    for (var E = l.type, r = e.attributes; r.length; )
        ...
        case 5:
            ...
            O0(l, e, u !== null ? u.memoizedProps : e)),
            a & 1024 && (nc = !0);
            break;
        case 6:
            if (it(t, l),
        ...
        case 13:
            it(t, l),
            st(l),
            l.child.flags & 8192 && l.memoizedState !== null != (u !== null && u.memoizedState !== null) && (rc = Et()),
            a & 4 && (a = l.updateQueue,
            a !== null && (l.updateQueue = null,
            fc(l, a)));
            break;
        case 22:
            if (a & 512 && (rl || u === null || $l(u, u.return)),
    ...
    function Y0(l, t, u, a) {
        ...
        case 22:
            n = t.stateNode,
            t.memoizedState !== null ? n._visibility & 4 ? du(l, t, u, a) : ae(l, t) : n._visibility & 4 ? du(l, t, u, a) : (n._visibility |= 4,
            va(l, t, u, a, (t.subtreeFlags & 10256) !== 0)),
            e & 2048 && cc(t.alternate, t);
            break;
        case 24:
            du(l, t, u, a),
            e & 2048 && ic(t.alternate, t);
            break;
        default:
            du(l, t, u, a)
        }
    ...
    function va(l, t, u, a, e) {
        ...
        t = t.child; t !== null; ) {
            ...
            case 22:
                var g = f.stateNode;
                f.memoizedState !== null ? g._visibility & 4 ? va(n, f, c, i, e) : ae(n, f) : (g._visibility |= 4,
                va(n, f, c, i, e)),
                e && v & 2048 && cc(f.alternate, f);
                break;
            case 24:
                va(n, f, c, i, e),
                e && v & 2048 && ic(f.alternate, f);
                break;
            default:
                va(n, f, c, i, e)
            }
    ...
    function ae(l, t) {
        if (t.subtreeFlags & 10256)
            for (t = t.child; t !== null; ) {
                ...
                case 22:
                    ae(u, a),
                    e & 2048 && cc(a.alternate, a);
                    break;
                case 24:
                    ae(u, a),
                    e & 2048 && ic(a.alternate, a);
                    break;
                default:
                    ae(u, a)
                }
    ...
    function B0(l) {
        ...
        case 26:
            ya(l),
            l.flags & ee && l.memoizedState !== null && eh(mt, l.memoizedState, l.memoizedProps);
            break;
        case 5:
            ya(l);
            break;
        ...
        case 22:
            ...
            t !== null && t.memoizedState !== null ? (t = ee,
            ee = 16777216,
            ya(l),
            ee = t) : ya(l));
            break;
    ...
    function vu(l, t) {
        var u = l.alternate;
        return u === null ? (u = dt(l.tag, t, l.key, l.mode),
    ...
    function hn(l, t, u, a, e, n) {
        ...
        typeof l == "function")
            ...
            f = uh(l, u, bt.current) ? 26 : l === "html" || l === "head" || l === "body" ? 27 : 5;
        else
            l: switch (l) {
            case D:
            ...
            case S:
                ...
                break;
            case q:
                return l = dt(12, u, t, e | 2),
                l.elementType = q,
                l.lanes = n,
                l;
            case Il:
                return l = dt(13, u, t, e),
                l.elementType = Il,
                l.lanes = n,
                l;
            case Kl:
                return l = dt(19, u, t, e),
                l.elementType = Kl,
                l.lanes = n,
                l;
            case ht:
    ...
    function dc(l, t, u) {
        return l = dt(6, l, null, t),
        l.lanes = u,
        l
    }
    function vc(l, t, u) {
        return t = dt(4, l.children !== null ? l.children : [], l.key, t),
        t.lanes = u,
        t.stateNode = {
    ...
    function C0(l, t) {
        ...
        !_d(t)) {
            if (t = ct.current,
            t !== null && ((W & 4194176) === W ? At !== null : (W & 62914560) !== W && (W & 536870912) === 0 || t !== At))
                throw Va = mf,
                es;
            l.flags |= 8192
        }
    ...
    function Sy(l, t, u) {
        ...
        case 3:
            ...
            (l === null || l.child === null) && (Xa(t) ? Ct(t) : l === null || l.memoizedState.isDehydrated && (t.flags & 256) === 0 || (t.flags |= 1024,
            rt !== null && (bc(rt),
            rt = null))),
            yl(t),
            null;
        case 26:
            ...
            u !== null ? (yl(t),
            C0(t, u)) : (yl(t),
            t.flags &= -16777217)) : u ? u !== l.memoizedState ? (Ct(t),
            yl(t),
            C0(t, u)) : (yl(t),
            t.flags &= -16777217) : (l.memoizedProps !== a && Ct(t),
            yl(t),
            t.flags &= -16777217),
            null;
        case 27:
        ...
        case 6:
            if (l && t.stateNode != null)
                ...
                Xa(t)) {
                    ...
                    l[ql] = t,
                    l = !!(l.nodeValue === u || a !== null && a.suppressHydrationWarning === !0 || vd(l.nodeValue, u)),
                    l || Mu(t)
                } else
            ...
            n === null)
                        ...
                        for (l = t.child; l !== null; ) {
                            ...
                            n !== null) {
                                ...
                                u = t.child; u !== null; )
                                    X0(u, l),
                                    u = u.sibling;
                                return vl(Ol, Ol.current & 1 | 2),
                                t.child
                            }
                            l = l.sibling
                        }
                    e.tail !== null && Et() > rn && (t.flags |= 128,
                    a = !0,
                    fe(e, !1),
                    t.lanes = 4194304)
                }
                ...
                if (!a)
                    ...
                    l !== null) {
                        ...
                        2 * Et() - e.renderingStartTime > rn && u !== 536870912 && (t.flags |= 128,
                        a = !0,
                        fe(e, !1),
                        t.lanes = 4194304);
    ...
    function V0() {
        vt === 0 && (vt = (W & 536870912) === 0 || k ? ei() : 536870912);
        var l = ct.current;
        return l !== null && (l.flags |= 32),
        vt
    }
    function Xl(l, t, u) {
        (l === sl && dl === 2 || l.cancelPendingCommit !== null) && (ra(l, 0),
        Lt(l, W, vt, !1)),
        Ma(l, u),
        ((hl & 2) === 0 || l !== sl) && (l === sl && ((hl & 2) === 0 && (Gu |= u),
        ml === 4 && Lt(l, W, vt, !1)),
        _t(l))
    }
    function L0(l, t, u) {
        ...
        do {
            if (e === 0) {
                ...
                l: {
                    ...
                    if (a.finishedWork = u,
                    a.finishedLanes = t,
                    (t & 62914560) === t && (n = rc + 300 - Et(),
                    10 < n)) {
                        if (Lt(a, t, vt, !Zt),
                        Re(a, 0) !== 0)
                            break l;
                        a.timeoutHandle = od(K0.bind(null, a, u, Ot, mn, oc, t, vt, Gu, oa, Zt, 2, -0, 0), n);
                        break l
                    }
                    K0(a, u, Ot, mn, oc, t, vt, Gu, oa, Zt, 0, -0, 0)
                }
            }
            break
        } while (!0);
    ...
    function K0(l, t, u, a, e, n, f, c, i, v, g, E, r) {
        var m = t.subtreeFlags;
        if ((m & 8192 || (m & 16785408) === 16785408) && (re = {
            stylesheets: null,
            count: 0,
            unsuspend: ah
        },
        ...
        t = nh(),
        t !== null)) {
            l.cancelPendingCommit = t(P0.bind(null, l, u, a, e, f, c, i, 1, E, r)),
            Lt(l, n, f, !v);
            return
        }
        P0(l, u, a, e, f, c, i, g, E, r)
    }
    function Ay(l) {
        for (var t = l; ; ) {
            var u = t.tag;
    ...
    function J0(l, t) {
        ...
        t === Za ? (t = cs(),
        dl = 3) : t === es ? (t = cs(),
        dl = 4) : dl = t === n0 ? 8 : t !== null && typeof t == "object" && typeof t.then == "function" ? 6 : 1,
        Fl = t,
        K === null && (ml = 1,
        cn(l, et(t, l.current)))
    }
    ...
    function Tc() {
        ml = 4,
        Zt || (W & 4194176) !== W && ct.current !== null || (ha = !0),
        (yu & 134217727) === 0 && (Gu & 134217727) === 0 || sl === null || Lt(sl, W, vt, !1)
    }
    function Ac(l, t, u) {
        var a = hl;
        hl |= 2;
    ...
    function k0(l) {
        ...
        case 15:
        case 0:
            t = v0(u, t, t.pendingProps, t.type, void 0, W);
            break;
        case 11:
            t = v0(u, t, t.pendingProps, t.type.render, t.ref, W);
            break;
        case 5:
            Df(t);
        default:
    ...
    function ma(l, t, u, a) {
        ...
        t.flags & 32768 ? (k || a === 1 ? l = !0 : ha || (W & 536870912) !== 0 ? l = !1 : (Zt = l = !0,
        (a === 2 || a === 3 || a === 6) && (a = ct.current,
    ...
    function Dy(l, t, u, a, e, n, f, c) {
        ...
        l === sl && (K = sl = null,
        W = 0),
        (i.subtreeFlags & 10256) === 0 && (i.flags & 10256) === 0 || gn || (gn = !0,
        mc = v,
        gc = u,
        Hy(De, function() {
            return ga(),
        ...
        u = (i.flags & 15990) !== 0,
        (i.subtreeFlags & 15990) !== 0 || u ? (u = N.T,
        N.T = null,
        n = O.p,
        O.p = 2,
        f = hl,
        ...
        return (ie & 3) !== 0 && ga(),
        v = l.pendingLanes,
        (a & 4194218) !== 0 && (v & 42) !== 0 ? l === Sc ? se++ : (se = 0,
        Sc = l) : se = 0,
        de(0),
        null
    }
        ...
        if (l.tag === 3)
            ...
            for (; t !== null; ) {
                if (t.tag === 3) {
                    ...
                    var a = t.stateNode;
                    if (typeof t.type.getDerivedStateFromError == "function" || typeof a.componentDidCatch == "function" && (hu === null || !hu.has(a))) {
                        l = et(u, l),
                        u = a0(2),
                        a = cu(t, u, 2),
                        a !== null && (e0(u, a, t, l),
    ...
    function My(l, t, u) {
        ...
        l.warmLanes &= ~u,
        sl === l && (W & u) === u && (ml === 4 || ml === 3 && (W & 62914560) === W && 300 > Et() - rc ? (hl & 2) === 0 && ra(l, 0) : hc |= u,
        oa === W && (oa = 0)),
        _t(l)
    }
    function td(l, t) {
    ...
    var En = null
      ...
      , Qu = 0;
    function _t(l) {
        l !== Sa && l.next === null && (Sa === null ? En = Sa = l : Sa = Sa.next = l),
        Tn = !0,
        Oc || (Oc = !0,
        py(Ny))
    }
    ...
    function ud(l, t) {
        for (var u = l.suspendedLanes, a = l.pingedLanes, e = l.expirationTimes, n = l.pendingLanes & -62914561; 0 < n; ) {
            var f = 31 - wl(n)
              , c = 1 << f
              , i = e[f];
            i === -1 ? ((c & u) === 0 || (c & a) !== 0) && (e[f] = av(c, t)) : i <= t && (l.expiredLanes |= c),
            n &= ~c
        }
        if (t = sl,
        u = W,
    ...
    function ad(l, t) {
        ...
        if (ga() && l.callbackNode !== u)
            return null;
        var a = W;
        return a = Re(l, l === sl ? a : 0),
        a === 0 ? null : (L0(l, a, t),
        ud(l, Et()),
        l.callbackNode != null && l.callbackNode === u ? ad.bind(null, l) : null)
    }
    function ed(l, t) {
        if (ga())
            return null;
    ...
    function nd(l) {
        return l == null || typeof l == "symbol" || typeof l == "boolean" ? null : typeof l == "function" ? l : Ye("" + l)
    }
    function fd(l, t) {
    ...
    function qy(l, t, u, a, e) {
        if (t === "submit" && u && u.stateNode === e) {
            var n = nd((e[Zl] || null).action)
              , f = a.submitter;
            f && (t = (t = f[Zl] || null) ? nd(t.formAction) : f.getAttribute("formAction"),
            t !== null && (n = t,
            f = null));
    ...
    ot(Wi, "onAnimationIteration"),
    ot($i, "onAnimationStart"),
    ot("dblclick", "onDoubleClick"),
    ot("focusin", "onFocus"),
    ot("focusout", "onBlur"),
    ot(Pv, "onTransitionRun"),
    ot(Iv, "onTransitionStart"),
    ot(ly, "onTransitionCancel"),
    ot(ki, "onTransitionEnd"),
    ...
    var ve = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" ")
      , jy = new Set("beforetoggle cancel close invalid load scroll scrollend toggle".split(" ").concat(ve));
    function cd(l, t) {
        t = (t & 4) !== 0;
    ...
    function Hc(l) {
        if (!l[An]) {
            ...
            vi.forEach(function(u) {
                u !== "selectionchange" && (jy.has(u) || Rc(u, !1, l),
                Rc(u, !0, l))
            });
        ...
        zi(function() {
            ...
            l: {
                ...
                if (r !== void 0) {
                    ...
                    var j = (t & 4) !== 0
                      , gl = !j && (l === "scroll" || l === "scrollend")
                      , y = j ? r !== null ? r + "Capture" : null : r;
                    j = [];
                    for (var d = v, h; d !== null; ) {
                        var b = d;
                        if (h = b.stateNode,
                        b = b.tag,
                        b !== 5 && b !== 26 && b !== 27 || h === null || y === null || (b = Ha(d, y),
                        b != null && j.push(ye(d, b, h))),
                        gl)
                            break;
                        d = d.return
                    }
                    0 < j.length && (r = new m(r,M,null,u,g),
                    E.push({
                        event: r,
                        listeners: j
                    }))
            ...
            if ((t & 7) === 0) {
                l: {
                    if (r = l === "mouseover" || l === "pointerover",
                    m = l === "mouseout" || l === "pointerout",
                    r && u !== Wn && (M = u.relatedTarget || u.fromElement) && (Eu(M) || M[Zu]))
                        break l;
                    if ((m || r) && (r = g.window === g ? g : (r = g.ownerDocument) ? r.defaultView || r.parentWindow : window,
                    m ? (M = u.relatedTarget || u.toElement,
                    m = v,
                    M = M ? Eu(M) : null,
                    M !== null && (gl = Y(M),
                    j = M.tag,
                    M !== gl || j !== 5 && j !== 27 && j !== 6) && (M = null)) : (m = null,
                    M = v),
                    m !== M)) {
                        if (j = Di,
                        b = "onMouseLeave",
                        y = "onMouseEnter",
                        d = "mouse",
                        (l === "pointerout" || l === "pointerover") && (j = Ui,
                        b = "onPointerLeave",
                        y = "onPointerEnter",
                        d = "pointer"),
                        gl = m == null ? r : Ra(m),
                        h = M == null ? r : Ra(M),
                        r = new j(b,d + "leave",m,u,g),
                        r.target = gl,
                        r.relatedTarget = h,
                        b = null,
                        Eu(g) === v && (j = new j(y,d + "enter",M,u,g),
                        j.target = h,
                        j.relatedTarget = gl,
                        b = j),
                        gl = b,
                ...
                l: {
                    ...
                    m === "select" || m === "input" && r.type === "file")
                        ...
                        m = r.nodeName,
                        !m || m.toLowerCase() !== "input" || r.type !== "checkbox" && r.type !== "radio" ? v && wn(v.elementType) && (_ = ji) : _ = wv;
                    if (_ && (_ = _(l, v))) {
                        Bi(E, _, u, g);
                        break l
                    }
                    V && V(l, r, v),
                    l === "focusout" && v && r.type === "number" && v.memoizedProps.value != null && Jn(r, "number", r.value)
                }
                switch (V = v ? Ra(v) : window,
                l) {
                case "focusin":
                    (Yi(V) || V.contentEditable === "true") && (Fu = V,
                    cf = v,
                    Ga = null);
                    break;
                case "focusout":
                ...
                if (af)
                    ...
                    ku ? pi(l, u) && (H = "onCompositionEnd") : l === "keydown" && u.keyCode === 229 && (H = "onCompositionStart");
                H && (Ri && u.locale !== "ko" && (ku || H !== "onCompositionStart" ? H === "onCompositionEnd" && ku && (U = Oi()) : (Pt = g,
                Pn = "value"in Pt ? Pt.value : Pt.textContent,
                ku = !0)),
                V = zn(v, H),
                0 < V.length && (H = new Mi(H,l,null,u,g),
                E.push({
                    event: H,
                    listeners: V
                }),
                U ? H.data = U : (U = qi(u),
                U !== null && (H.data = U)))),
                (U = Qv ? Cv(l, u) : Zv(l, u)) && (H = zn(v, "onBeforeInput"),
                0 < H.length && (V = new Mi("onBeforeInput","beforeinput",null,u,g),
                E.push({
                    event: V,
                    listeners: H
                }),
    ...
    function sd(l, t, u, a, e) {
        for (var n = t._reactName, f = []; u !== null && u !== a; ) {
            ...
            i !== null && i === a)
                break;
            c !== 5 && c !== 26 && c !== 27 || v === null || (i = v,
            e ? (v = Ha(u, n),
            v != null && f.unshift(ye(u, v, i))) : e || (v = Ha(u, n),
            v != null && f.push(ye(u, v, i)))),
            u = u.return
        }
        f.length !== 0 && l.push({
            event: t,
...
`).replace(Gy, "")
    ...
    function nl(l, t, u, a, e, n) {
        ...
        case "textContent":
            break;
        default:
            (!(2 < u.length) || u[0] !== "o" && u[0] !== "O" || u[1] !== "n" && u[1] !== "N") && (u = hv.get(u) || u,
            He(l, u, a))
        }
    }
    ...
    function Xy(l, t, u, a) {
            ...
            for (m in u) {
                ...
                if (u.hasOwnProperty(m) && E != null)
                    ...
                    case "defaultValue":
                        i = E;
                    default:
                        a.hasOwnProperty(m) || nl(l, t, m, null, a, E)
                    }
            }
            for (var r in a) {
                var m = a[r];
                if (E = u[r],
                a.hasOwnProperty(r) && (m != null || E != null))
                    switch (r) {
                    case "type":
                        n = m;
                        break;
        ...
        case "select":
            ...
            u = f,
            a = m,
            r != null ? Ju(l, !!u, r, !1) : !!a != !!u && (t != null ? Ju(l, !!u, t, !0) : Ju(l, !!u, u ? [] : "", !1));
            return;
        case "textarea":
            m = r = null;
            for (c in u)
        ...
        case "menuitem":
            for (var j in u)
                r = u[j],
                u.hasOwnProperty(j) && r != null && !a.hasOwnProperty(j) && nl(l, t, j, null, a, r);
            for (v in a)
                if (r = a[v],
                m = u[v],
        ...
        default:
            if (wn(t)) {
                for (var gl in u)
                    r = u[gl],
                    u.hasOwnProperty(gl) && r !== void 0 && !a.hasOwnProperty(gl) && pc(l, t, gl, void 0, a, r);
                for (g in a)
                    r = a[g],
                    m = u[g],
                    !a.hasOwnProperty(g) || r === m || r === void 0 && m === void 0 || pc(l, t, g, r, a, m);
                return
            }
        }
        for (var y in u)
            r = u[y],
            u.hasOwnProperty(y) && r != null && !a.hasOwnProperty(y) && nl(l, t, y, null, a, r);
        for (E in a)
            r = a[E],
            m = u[E],
            !a.hasOwnProperty(E) || r === m || r == null && m == null || nl(l, t, E, r, a, m)
    }
    var qc = null
      , Yc = null;
    function _n(l) {
    ...
    var od = typeof setTimeout == "function" ? setTimeout : void 0
      ...
      , Zy = typeof queueMicrotask == "function" ? queueMicrotask : typeof rd < "u" ? function(l) {
        return rd.resolve(null).then(l).catch(Vy)
    }
    : od;
    function Vy(l) {
        setTimeout(function() {
    ...
    function Ky(l, t, u) {
        if (t === "")
            return null;
        for (; l.nodeType !== 3; )
            if ((l.nodeType !== 1 || l.nodeName !== "INPUT" || l.type !== "hidden") && !u || (l = gt(l.nextSibling),
            l === null))
                return null;
        return l
    }
    ...
    function ky(l, t, u) {
        ...
        if (a && l && t) {
            ...
            yt.set(n, l),
            a.querySelector(e) !== null || t === "style" && a.querySelector(he(n)) || t === "script" && a.querySelector(oe(n)) || (t = a.createElement("link"),
            pl(t, "link", l),
            Dl(t),
            a.head.appendChild(t)))
        }
    ...
    function Ed(l, t, u, a) {
        ...
        case "link":
            if (u.rel === "stylesheet" && typeof u.href == "string" && typeof u.precedence == "string") {
                ...
                n.set(l, f),
                (n = e.querySelector(he(l))) && !n._p && (f.instance = n,
                f.state.loading = 5),
                yt.has(l) || (u = {
                    rel: "preload",
                    as: "style",
    ...
    function Ad(l, t, u) {
        ...
        t.instance === null)
            ...
            case "script":
                return n = Aa(u.src),
                (e = l.querySelector(oe(n))) ? (t.instance = e,
                Dl(e),
                e) : (a = u,
                (e = yt.get(n)) && (a = I({}, u),
                Qc(a, e)),
    ...
    function zd(l, t, u) {
        ...
        e = 0; e < u.length; e++) {
            var n = u[e];
            if (!(n[Ua] || n[ql] || l === "link" && n.getAttribute("rel") === "stylesheet") && n.namespaceURI !== "http://www.w3.org/2000/svg") {
    ...
    function Dd(l, t, u, a, e, n, f, c, i, v, g, E) {
        return l = new ch(l,t,u,f,c,i,v,E),
        t = 1,
        n === !0 && (t |= 24),
        n = dt(3, null, null, t),
        l.current = n,
    ...
    function vh(l, t, u, a, e) {
        switch (t) {
        case "focusin":
            return ou = be(ou, l, t, u, a, e),
            !0;
        case "dragenter":
            return ru = be(ru, l, t, u, a, e),
            !0;
        case "mouseover":
            return mu = be(mu, l, t, u, a, e),
            !0;
        case "pointerover":
            var n = e.pointerId;
            return ge.set(n, be(ge.get(n) || null, l, t, u, a, e)),
            !0;
        case "gotpointercapture":
            return n = e.pointerId,
            Se.set(n, be(Se.get(n) || null, l, t, u, a, e)),
            !0
        }
        return !1
    }
    ...
    jn.prototype.render = wc.prototype.render = function(l) {
    ...
    ,
    jn.prototype.unmount = wc.prototype.unmount = function() {
...
var Oh = zh();
function _h() {
    return ll.jsx("header", {
        className: "bg-gray-100 p-6 shadow-sm border-2 border-solid ",
        children: ll.jsx("h1", {
            className: "text-3xl font-semibold text-center text-gray-800 transition-all duration-300 hover:scale-102",
            children: "AJAY AI"
        })
    })
}
...
function Dh({activeChat: A, chatHistory: al, updateChatHistory: G}) {
 ...
 $ = {
        ...
        try {
            ...
            return zl.error ? (console.error("API Error:", zl.error),
            "Error: " + zl.error.message) : zl.candidates[0].content.parts[0].text
        } catch (fl) {
            return console.error("Fetch Error:", fl),
    ...
    ;
    return ll.jsxs("div", {
        className: "flex flex-col items-center p-6 w-full max-w-4xl mx-auto",
        children: [ll.jsx("h2", {
            className: "text-3xl font-bold text-gray-900 mb-6",
            children: A
        }), ll.jsxs("div", {
            className: "flex flex-col w-full space-y-4 mb-6 overflow-y-auto max-h-[60vh]",
            children: [Array.isArray(al) && al.map( (S, q) => ll.jsx("div", {
                className: `flex items-start ${S.sender === "user" ? "justify-end" : "justify-start"}`,
                children: ll.jsx("div", {
                    className: `max-w-xs p-4 rounded-lg text-white ${S.sender === "user" ? "bg-gradient-to-r from-sky-400 to-indigo-500" : "bg-gray-800 text-gray-800"} shadow-sm hover:shadow-md transition-all duration-300`,
                    children: ll.jsx("p", {
                        className: "text-lg",
                        children: S.text
                    })
                ...
                children: ll.jsx("div", {
                    className: "animate-spin border-t-4 border-white w-8 h-8 rounded-full border-solid"
                })
            })]
        }), ll.jsxs("div", {
            className: "flex w-full items-center justify-between mt-4 space-x-2",
            children: [ll.jsx("input", {
                type: "text",
                value: o,
                onChange: S => B(S.target.value),
                placeholder: "Ask Ajay something...",
...
function Mh({chats: A, setActiveChat: al, addNewChat: G, removeChat: o, exportChatHistory: B}) {
    return ll.jsxs("div", {
        className: "bg-gray-100 p-6 w-full min-w-[250px] h-full shadow-sm rounded-lg flex flex-col text-gray-800 transition-all duration-300 hover:scale-102 hover:shadow-md border-2 border-solid ",
        children: [ll.jsx("div", {
            className: "mb-6 text-center",
            children: ll.jsx("button", {
                onClick: G,
            ...
            children: A.map( (L, tl) => ll.jsxs("div", {
...
function Uh() {
    const [A,al] = za.useState([])
      , [G,o] = za.useState(null)
      , [B,L] = za.useState({})
      , tl = () => {
        const q = `Chat ${A.length + 1}`;
        al([...A, q]),
        o(q),
        L(Z => ({
            ...Z,
      ...
      , D = () => {
        const q = JSON.stringify(B[G])
          , Z = `data:text/json;charset=utf-8,${encodeURIComponent(q)}`
          , $ = `${G}_chat_history.json`
          , fl = document.createElement("a");
        fl.setAttribute("href", Z),
    ...
    ;
    return ll.jsxs("div", {
        className: "h-screen bg-white text-gray-900 flex flex-col",
        children: [ll.jsx(_h, {}), ll.jsxs("div", {
            className: "flex h-full overflow-hidden",
            children: [ll.jsx("div", {
                className: "w-1/5 bg-white p-6 border-r border-gray-300 rounded-lg shadow-sm hover:shadow-md transition-all duration-300",
                children: ll.jsx(Mh, {
                    chats: A,
                    setActiveChat: o,
                    addNewChat: tl,
...
Oh.createRoot(document.getElementById("root")).render(ll.jsx(za.StrictMode, {
    children: ll.jsx(Uh, {})
}));
